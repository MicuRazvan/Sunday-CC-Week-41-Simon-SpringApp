...
For this week, we decided to build a variation of Simon game using Spring. I'm allowed to work on it only Sunday.
...
## About the project
More information about the base game and rules: https://en.wikipedia.org/wiki/Simon_(game)
